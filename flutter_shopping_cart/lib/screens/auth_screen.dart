...
class _AuthCardState extends State<AuthCard> {
  ...
  void _submit() async {
    ...
    } on HttpsException catch (ex) {
      var errorMessage = 'Authentication Failed.';
      if (ex.toString().contains('EMAIL_EXISTS')) {
        errorMessage = 'This email is already in use';
      } else if (ex.toString().contains('INVALID_EMAIL')) {
        errorMessage = 'This is not valid email';
      } else if (ex.toString().contains('WEAK_PASSWORD')) {
        errorMessage = 'This password is too weak';
      } else if (ex.toString().contains('EMAIL_NOT_FOUND')) {
        errorMessage = 'could not find the user with the email address';
      } else if (ex.toString().contains('INVALID_PASSWORD')) {
